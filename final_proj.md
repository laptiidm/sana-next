...
# 📌 План розвитку фіч для аплікації "Підрахунок калорій"

| Рівень                                    | Фічі                                   | Опис                                                    |
| ----------------------------------------- | -------------------------------------- | ------------------------------------------------------- |
| **MVP** (мінімально життєздатний продукт) | 🔹 Пошук продуктів (FatSecret API)     | Користувач вводить назву продукту, отримує список з API |
|                                           | 🔹 Вибір порції/ваги                   | Обирає кількість (100 г, 1 шт і т.п.)                   |
|                                           | 🔹 Сумарний підрахунок калорій за день | Автоматичне оновлення після додавання продуктів         |
|                                           | 🔹 Список продуктів за день            | Відображення всіх доданих продуктів                     |
|                                           | 🔹 Видалення продуктів                 | Можливість прибрати продукт зі списку                   |
|                                           | 🔹 Mobile-first UI                     | Зручний інтерфейс для смартфонів                        |
| **Базові покращення**                     | 🔹 Добова норма калорій                | Користувач задає ціль (наприклад, 2000 ккал)            |
|                                           | 🔹 Відображення прогресу               | “Спожито 1200 із 2000 (залишилось 800)”                 |
|                                           | 🔹 Історія харчування                  | Перегляд даних за попередні дні                         |
|                                           | 🔹 Статистика (графіки)                | Динаміка калорій, БЖВ по днях/тижнях                    |
|                                           | 🔹 Улюблені продукти                   | Швидкий доступ до часто доданих продуктів               |
| **Advanced (розвиток продукту)**          | 🔹 Сканування штрих-коду               | Автоматичне визначення продуктів через камеру           |
|                                           | 🔹 Персональні підказки                | Рекомендації на основі історії                          |
|                                           | 🔹 Інтеграція з фітнес-трекерами       | Синхронізація з Google Fit, Apple Health тощо           |
|                                           | 🔹 Розрахунок БЖВ                      | Відображення білків, жирів, вуглеводів                  |
|                                           | 🔹 Рецепти та страви                   | Створення власних страв і підрахунок калорій            |
|                                           | 🔹 Офлайн-режим                        | Робота без інтернету з локальним кешем                  |
| **Гейміфікація та мотивація**             | 🔹 Досягнення                          | “5 днів поспіль в нормі калорій”                        |
|                                           | 🔹 Щоденні/тижневі цілі                | Додаткові виклики для користувача                       |
|                                           | 🔹 Push-сповіщення                     | Нагадування про прийоми їжі                             |
